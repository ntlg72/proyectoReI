...
// Continuar con el procesamiento del carrito...


if (isset($_POST['action']) && $_POST['action'] === 'eliminar') {
    $product_id = $_POST['product_id']; // Asegúrate de que el carrito_id esté disponible en tu formulario
    ...
    if ($result === false) {
        ...
        // Redirigir a ver-carrito.php después de confirmar la eliminación
